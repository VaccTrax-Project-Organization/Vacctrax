...
import {ViewVaccineDetailsDialogComponent} from "../../../shared/pages/view-vaccine-details-dialog/view-vaccine-details-dialog.component";
...
export class VaccinesListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  */
  ...
  public openViewVaccineDetailsDialog(element: Vaccine): void {
    const dialogRef = this.dialog.open(ViewVaccineDetailsDialogComponent, {
      panelClass: 'dialog-panel-class',
      data: element
    });
  }
